...
_SUBJECT_ALIASES = {
    ...
    # 고2 수1 계열
    "수1": "대수", "수학1": "대수", "대수": "대수",
    # 고2 수2 계열(미적분Ⅰ) — 줄임말 "미적1"·로마숫자 "미적분I" 도 인식(미래엔황 등 출판사
    # 파일명이 "[미적1]" 로 줄여 쓰는데 별칭에 없어 과목 미인식→폼 자동선택 포기됐다, 2026-06-18).
    "수2": "미적분1", "수학2": "미적분1", "미적분1": "미적분1",
    "미적1": "미적분1", "미적분I": "미적분1", "미적분Ⅰ": "미적분1",
    # 선택과목(미적분Ⅱ=진로선택)
    "미적분": "미적분2", "미적분2": "미적분2",
    "미적2": "미적분2", "미적분II": "미적분2", "미적분Ⅱ": "미적분2",
    "기하": "기하",
